...
-- Spell rows scrollable container
local spellScrollFrame = CreateFrame("ScrollFrame", "RaidCD_SpellScrollFrame", listFrame, "UIPanelScrollFrameTemplate")
spellScrollFrame:SetPoint("TOPLEFT", header, "TOPLEFT", 0, 0)
spellScrollFrame:SetPoint("BOTTOMRIGHT", listFrame, "BOTTOMRIGHT", 0, 4)

local spellRowsParent = CreateFrame("Frame", nil, spellScrollFrame)
spellScrollFrame:SetScrollChild(spellRowsParent)
spellRowsParent:SetWidth(LIST_W - 20)
...
RebuildSpellList = function()
    ...
    spellRowsParent:SetHeight(math.max(headerOffset + contentH, LIST_H - 8))
