...
eventFrame:SetScript(
    ...
    function(frame, elapsed)
        ...
        if now - lastBuffRefresh >= 5 then
            if RaidCD.ui and RaidCD.ui.buffWindow and RaidCD.ui.buffWindow.mainFrame and RaidCD.ui.buffWindow.mainFrame:IsVisible() then
                RaidCD.ui.buffWindow.Refresh()
            end
            lastBuffRefresh = now
        end
